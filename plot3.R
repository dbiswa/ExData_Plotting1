...
# Command to generate Plot3.png
# Open a png plot device to create Plot3.png with a width of 480 pixels and a height of 480 pixels
...
with(hpc, plot(Date, Sub_metering_1, type = "l", ylab = "Energy sub metering",xlab = "", col = "black"))
