...
# Command to generate Plot4.png
# Open a png plot device to create Plot4.png with a width of 480 pixels and a height of 480 pixels
png(file = "Plot4.png", width = 480, height = 480, units = "px")
# use par command to set the number of rows and columns with mfrow, background (transparent is default), and margin
par(mfrow = c(2,2), bg = "white", mar = c(5,4,2,1))
# command to generate four plots
with(hpc, {
  plot(Date, Global_active_power, type = "l", ylab = "Global Active Power",xlab = "", col = "black")
  plot(Date, Voltage, type = "l", ylab = "Voltage", xlab = "datetime", col = "black")
  plot(Date, Sub_metering_1, type = "l", ylab = "Energy sub metering",xlab = "", col = "black")  
  lines(Date, Sub_metering_2, col="red")
  lines(Date, Sub_metering_3, col="blue") 
  legend("topright", bty = "n", lty = c(1, 1, 1), col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))
  plot(Date, Global_reactive_power, type = "l", xlab = "datetime", col = "black")
})  
dev.off()